		...
		<div class="block">
			...
			<div class="block-content">
                ...
                <div class="form-group <?=$validation->hasError('block_id')?'is-invalid':''?>">
                    ...
                    <?php echo form_dropdown('block_id', array(), set_value('block_id', ''),"id='block_id' class='form-control js-select2'"); ?>
				...
				<div class="form-group <?=$validation->hasError('name')?'is-invalid':''?>">
					...
					<?php echo form_input(array('class'=>'form-control','name' => 'name', 'id' => 'name', 'placeholder'=>'Cluster Name','value' => set_value('name', $name))); ?>
				...
				<div class="form-group <?=$validation->hasError('gp_id')?'is-invalid':''?>">
					...
					<?php echo form_dropdown('gp_id[]', array(), set_value('gp_id[]', ''),"id='gp_id' class='form-control js-select2' multiple='multiple'"); ?>
