<div class="block" id="tentative_abstract">
    <div class="block-header block-header-default">
        <h3 class="block-title"><?php echo $result['title'];?></h3>
    ...
    <div class="block-content block-content-full">
        ...
        <div class="table-responsive" style="overflow:auto;position:relative;">
            <p class="text-center heading"><?php echo $result['subtitle'];?></p>
            <table class="table table-bordered table-striped">
                ...
                foreach($result['submissions'] as $key=>$submission){
